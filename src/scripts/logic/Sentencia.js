...
Sentencia.prototype.ejecutarS = function (){
    this.ejecutar(this.root);
};

Sentencia.prototype.ejecutar = function (root){
    switch(produccion) {
        case "S=>SENTENCIAS EOF":
        {
            this.ejecutar(root.getHijo(0));
            break;
        }
        case "SENTENCIAS=>SENTENCIA SENTENCIAS":
        {
            this.ejecutar(root.getHijo(0));
            this.ejecutar(root.getHijo(1));
            break;
        }
        case "SENTENCIAS=>":
        {
        ...
        case "CONDICION_OR_P: or_ CONDICION_OR":
        {
            break;
        }
        ...
        default:
        {
            console.info("Sentencias.ejecutar: case no found. root.produccion: "+root.getProduccion());
            break;
        }
